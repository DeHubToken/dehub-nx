 ...
 * });
 */
export function useTeamMembersQuery(baseOptions?: Apollo.QueryHookOptions<models.TeamMembersQuery, models.TeamMembersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<models.TeamMembersQuery, models.TeamMembersQueryVariables>(TeamMembersDocument, options);
      }
export function useTeamMembersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<models.TeamMembersQuery, models.TeamMembersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<models.TeamMembersQuery, models.TeamMembersQueryVariables>(TeamMembersDocument, options);
        }
...
export type TeamMembersQueryResult = Apollo.QueryResult<models.TeamMembersQuery, models.TeamMembersQueryVariables>;