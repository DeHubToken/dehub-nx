...
export const ApplicationSlice = createSlice({
  ...
  reducers: {
    ...
    setSourceChain: (
      state,
      action: PayloadAction<{ chain: ChainType }>
    ) => {
...
export const { setUpdateState, setTokenAmount, setApplicationStatus, setSourceChain, setDstChain } = ApplicationSlice.actions;
